...
:uri-build-status: https://dev.azure.com/sc-sq-c-family-examples/macos-cmake-azure-sc/_build/latest?definitionId=3&branchName=main
:img-build-status: https://dev.azure.com/sc-sq-c-family-examples/macos-cmake-azure-sc/_apis/build/status/sc-sq-c-family-examples.macos-cmake-azure-sc?branchName=main
